...
func BuildDiscovery(cfg Config, version string) []DiscoveryEntity {
	...
	entities = appendDiscoveryEntity(entities, discoveryPrefix, "sensor", "pw_net_wh", sensorPayload(base, deviceID, "pw_net_wh", "Net Energy", "{{ '%.2f' | format(value_json.pw_net_wh | float) }}", "Wh", "", "measurement", "diagnostic"))
