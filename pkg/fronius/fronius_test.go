...
func TestHandler(t *testing.T) {
	...
	setup()
	_, err := fronius.Handler(pwForecast, pwBatt2charge, pwBattMax, pwConsumption, maxCharge, pw_batt_reserve, startHr, endHr, modbus_ip, true, modbus_port)
	teardown()
...
func TestBatteryChargeMode1(t *testing.T) {
	assert := assert.New(t)
	setup()
	result, err := fronius.SetFroniusChargeBatteryMode(1000, 0, 11000, 9000, 3500, 0, "00:00", "05:00", modbus_ip, true, modbus_port)
...
func TestBatteryChargeMode2(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(1000, 11000, 11000, 9000, 3500, 0, "00:00", "23:59", modbus_ip, true, modbus_port)
...
func TestBatteryChargeMode3(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(10000, 5000, 11000, 9000, 3500, 0, "00:00", "23:59", modbus_ip, true, modbus_port)
	assert.Equal(int16(0), result, "SetFroniusChargeBatteryMode returned wrong value")
	assert.NoError(err)
...
func TestBatteryChargeMode4(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(10000, 0, 11000, 9000, 3500, 0, "00:00", "23:59", modbus_ip, true, modbus_port)
	assert.Equal(int16(0), result, "SetFroniusChargeBatteryMode returned wrong value")
	assert.NoError(err)
...
func TestBatteryChargeMode5(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(1000, 11000, 11000, 9000, 3500, 2500, "00:00", "23:59", modbus_ip, true, modbus_port)
	assert.Equal(int16(31), result, "SetFroniusChargeBatteryMode returned wrong value")
	assert.NoError(err)
...
func TestBatteryChargeMode6(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(8000, 2000, 11000, 8000, 3500, 0, "00:00", "23:59", modbus_ip, true, modbus_port)
	assert.Equal(int16(0), result, "SetFroniusChargeBatteryMode returned wrong value")
	assert.NoError(err)
...
func TestBatteryChargeMode7(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(10000, 7000, 11000, 0, 3500, 5000, "00:00", "23:59", modbus_ip, true, modbus_port)
...
func TestBatteryChargeMode8(t *testing.T) {
	...
	result, err := fronius.SetFroniusChargeBatteryMode(5000, 7000, 11000, 10000, 3500, 3000, "00:00", "23:59", modbus_ip, true, modbus_port)
	assert.Equal(int16(9), result, "SetFroniusChargeBatteryMode returned wrong value")
	assert.NoError(err)
