...
func SetFroniusChargeBatteryMode(pw_forecast float64, pw_batt2charge float64, pw_batt_max float64, pw_consumption float64, max_charge float64, pw_batt_reserve float64, start_hr string, end_hr string, fronius_ip string, batt_reserve_charge_enabled bool, fronius_port ...string) (int16, error) {
	p := "502"
	...
	case pw_batt < pw_batt_reserve && batt_reserve_charge_enabled: // battery is less than reserve and reserve battery is time enabled => charge
